...
* [ ] also move into this stuff?
	* [ ] grime?
	* [ ] mechanical tech?
		* [X] Modern subs suffer from the same story-telling-killing problem that all modern technology has: they are so complex almost _anything_ is believable
			* [ ] (list some real technology modern subs have)
			* [X] (In many ways the idea of a subconscious object fits best here.)
			* [X] The technology is essentially magical. Harry Potter aside, it becomes difficult to tell a compelling story when virtually anything could happen or be believed.
